...
def analyze_pairs():
    ...
    for yf_ticker1, yf_ticker2, name1, name2 in PAIRS:
        try:
            ...
            # UPDATED ENTRY CONDITION TO 1.0
            if abs(current_z) > 1.0:
                ...
                # UPDATED TARGETS AND STOP LOSS DISTANCES
                delta_z_tp1 = abs(current_z - 0.5)  # TP1 is now at Z=0.5
                delta_z_tp2 = abs(current_z - 0.0)  # TP2 is full reversion at Z=0.0
                delta_z_sl = abs(current_z - 4.0)   # UPDATED SL to Z=4.0
